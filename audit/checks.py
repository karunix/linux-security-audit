...
def check_permit_root_login(
    ...
    if observed_value == "yes":
        ...
        severity = Severity.MEDIUM  # default / not set
...
def check_sudo_nopasswd():
    ...
    if not findings:
        return Finding(
            ...
            severity=Severity.INFO,
            explanation="All sudo operations require authentication, reducing the risk of unchecked privilege escalation.",
